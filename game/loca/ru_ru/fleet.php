...
$LOCA["ru"]["FLEET_PLANETTYPE_1"] = "планета";
$LOCA["ru"]["FLEET_PLANETTYPE_2"] = "поле обломков";
$LOCA["ru"]["FLEET_PLANETTYPE_3"] = "луна";

// flotten1

$LOCA["ru"]["FLEET1_HOLD"] = "На планете";
$LOCA["ru"]["FLEET1_HOLD_SHORT"] = "(Д)";
$LOCA["ru"]["FLEET1_RETURN"] = "Возвращение к планете";
...
$LOCA["ru"]["FLEET1_HEAD1"] = "Номер";
$LOCA["ru"]["FLEET1_HEAD2"] = "Задание";
$LOCA["ru"]["FLEET1_HEAD3"] = "Численность";
$LOCA["ru"]["FLEET1_HEAD4"] = "Отправлен с";
$LOCA["ru"]["FLEET1_HEAD5"] = "Отправлен";
$LOCA["ru"]["FLEET1_HEAD6"] = "Отправлен на";
$LOCA["ru"]["FLEET1_HEAD7"] = "Прибудет";
$LOCA["ru"]["FLEET1_HEAD8"] = "Приказ";

$LOCA["ru"]["FLEET1_BUTTON_ACS"] = "Союз";
$LOCA["ru"]["FLEET1_BUTTON_RECALL"] = "Отзыв";

$LOCA["ru"]["FLEET1_ACS_NAME"] = "Союз флотов #1";
$LOCA["ru"]["FLEET1_ACS_TITLE"] = "Изменить название союза";
$LOCA["ru"]["FLEET1_ACS_PLAYERS"] = "Приглашённые участники";
$LOCA["ru"]["FLEET1_ACS_INVITE"] = "Пригласить участника";

$LOCA["ru"]["FLEET1_ERROR_MAX"] = "Достигнута максимальная численность флота!";
$LOCA["ru"]["FLEET1_TITLE_CHOOSE"] = "Новое задание: выбрать корабли";
$LOCA["ru"]["FLEET1_TYPE"] = "Тип корабля";
$LOCA["ru"]["FLEET1_AMOUNT"] = "В наличии";
$LOCA["ru"]["FLEET1_SPEED"] = "Скорость";
$LOCA["ru"]["FLEET1_CLEAR"] = "Обнулить";
...
$LOCA["ru"]["FLEET2_SEND_FLEET"] = "Отправление флота";
$LOCA["ru"]["FLEET2_COORD"] = "Координаты цели";
$LOCA["ru"]["FLEET2_SPEED"] = "Скорость";
$LOCA["ru"]["FLEET2_DIST"] = "Расстояние";
$LOCA["ru"]["FLEET2_DURATION"] = "Продолжительность (в одну сторону)";
$LOCA["ru"]["FLEET2_CONS"] = "Потребление топлива";
$LOCA["ru"]["FLEET2_MAX_SPEED"] = "Максимальная скорость";
$LOCA["ru"]["FLEET2_CARGO"] = "Грузоподъёмность";
$LOCA["ru"]["FLEET2_HEAD_PLANETS"] = "Планета";
$LOCA["ru"]["FLEET2_HEAD_ACS"] = "Боевые союзы  ";
$LOCA["ru"]["FLEET2_NEXT"] = "Дальше";

// flotten3

$LOCA["ru"]["FLEET3_ORDER"] = "Задание";
$LOCA["ru"]["FLEET3_NO_ORDER"] = "Нет подходящих заданий";
$LOCA["ru"]["FLEET3_EXP_WARNING"] = "ВНИМАНИЕ! Экспедиция - очень рискованная миссия, не предназначенная для сэйва.";
$LOCA["ru"]["FLEET3_RESOURCES"] = "Сырьё";
$LOCA["ru"]["FLEET3_RES_LEFT"] = "Остаток";
$LOCA["ru"]["FLEET3_RES_ALL"] = "Всё сырьё";
$LOCA["ru"]["FLEET3_ACS"] = "Боевые союзы";
$LOCA["ru"]["FLEET3_HOLD_TIME"] = "Время пребывания";
$LOCA["ru"]["FLEET3_HOLD_HOURS"] = "Время в часах";
$LOCA["ru"]["FLEET3_NEXT"] = "Дальше";

// fleet_template

$LOCA["ru"]["FLEET_TEMP_TITLE_MAX"] = "Стандартные флоты (макс. #1)";
$LOCA["ru"]["FLEET_TEMP_NAME"] = "Название";
$LOCA["ru"]["FLEET_TEMP_UPDATE"] = "Обработать";
$LOCA["ru"]["FLEET_TEMP_DELETE"] = "Удалить";
$LOCA["ru"]["FLEET_TEMP_CREATE"] = "Создать новый стандартный флот";
$LOCA["ru"]["FLEET_TEMP_SAVE"] = "Сохранить";
