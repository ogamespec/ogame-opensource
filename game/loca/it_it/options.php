...
$LOCA["it"]["OPTIONS_USER_NEWPASS2"] = "Nuova Password (ripeti)";
$LOCA["it"]["OPTIONS_USER_EMAIL"] = "Indirizzo Email";
$LOCA["it"]["OPTIONS_USER_EMAIL_TIP"] = "Puoi cambiare indirizzo email in qualsiasi momento e diventera&grave; indirizzo email permanente dopo 7 giorni.";
...
$LOCA["it"]["OPTIONS_GENERAL_ORDER3"] = "Alfabetico";
$LOCA["it"]["OPTIONS_GENERAL_ORDERBY"] = "Sequenziale:";
...
$LOCA["it"]["OPTIONS_GALAXY_SPY"] = "Spionaggio";
$LOCA["it"]["OPTIONS_GALAXY_MSG"] = "Scrivi messaggio";
$LOCA["it"]["OPTIONS_GALAXY_BUDDY"] = "Richiesta amicizia";
$LOCA["it"]["OPTIONS_GALAXY_ROCKET"] = "Attacco missilistico";
$LOCA["it"]["OPTIONS_GALAXY_REPORT"] = "Visualizza report";

$LOCA["it"]["OPTIONS_MSG"] = "Opzioni Messaggi";
$LOCA["it"]["OPTIONS_MSG_SORT"] = "Nessun filtro messaggi";

$LOCA["it"]["OPTIONS_ACCOUNT"] = "Modalit&agrave; Vacanza / Cancella account";
$LOCA["it"]["OPTIONS_ACCOUNT_VM"] = "Attiva modalit&agrave; vacanza";
$LOCA["it"]["OPTIONS_ACCOUNT_VM_TIP"] = "La modalit&agrave; vacanza ti protegge da attacchi. Una volta attivata non potrai pi&ugrave; muovere flotte, ricercare o costruire per un minimo di 2 giorni dall'attivazione.";
$LOCA["it"]["OPTIONS_ACCOUNT_DEL"] = "Cancella account";
$LOCA["it"]["OPTIONS_ACCOUNT_DEL_TIP"] = "Spuntando questa casella il tuo account sar&agrave; cancellato dopo 7 giorni.";
...
$LOCA["it"]["OPTIONS_ERR_OLDPASS"] = "Vecchia password inserita non corretta";
$LOCA["it"]["OPTIONS_ERR_EMAIL"] = "Indirizzo email non valido";
$LOCA["it"]["OPTIONS_ERR_EMAILUSED"] = "Questa email &egrave; gi&agrave; in uso!";
$LOCA["it"]["OPTIONS_ERR_NEWPASS"] = "Le password non corrispondono!";
$LOCA["it"]["OPTIONS_ERR_NAME"] = "Nome utente non consentito!";
$LOCA["it"]["OPTIONS_ERR_PASS_SPECIAL"] = "Inseriti caratteri speciali nella password.";
$LOCA["it"]["OPTIONS_ERR_NAME_WEEK"] = "Il nome utente pu&ograve; essere cambiato solo una volta ogni 7 giorni.";
$LOCA["it"]["OPTIONS_ERR_NAME_SPECIAL"] = "Il nome utente non pu&ograve; contenere caratteri speciali.";
$LOCA["it"]["OPTIONS_ERR_VM"] = "Non puoi attivare la modalit&agrave; vacanza con flotte in movimento, con costruzioni o ricerche in corso.";
$LOCA["it"]["OPTIONS_ERR_PASS_8"] = "La password deve contenere almeno 8 caratteri";
$LOCA["it"]["OPTIONS_ERR_EMAIL_64"] = "Massimo 64 caratteri per indirizzo email.";
$LOCA["it"]["OPTIONS_ERR_NAME_3_20"] = "Il nome giocatore deve contenere dai 3 ai 20 caratteri.";
$LOCA["it"]["OPTIONS_ERR_EXISTNAME"] = "Nome utente gi&agrave; in uso.";

$LOCA["it"]["OPTIONS_ACTIVATE_EMAIL"] = "Utilizzare l'indirizzo inserito";
$LOCA["it"]["OPTIONS_ACTIVATE_INFO"] = "Il tuo account di gioco non è ancora stato attivato. Qui puoi ordinare un'e-mail con un link di attivazione.";
$LOCA["it"]["OPTIONS_ACTIVATE_SUBMIT"] = "Link di attivazione dell'ordine";
