...
// Attaque gravitationnelle (destruction de la lune)
// TODO: Prendre les messages du jeu officiel actuel.

$LOCA["fr"]["GRAVITON_ATK_SUBJ"] = "Лунная атака";
$LOCA["fr"]["GRAVITON_DEF_SUBJ"] = "Лунные толчки";

// Pour l'attaquant.

$LOCA["fr"]["GRAVITON_ATK_00"] = "Флот с #1 #2 достигает луны планеты на #3 .\n" .
...
$LOCA["fr"]["GRAVITON_ATK_01"] = "Флот с планеты #1 #2 достигает луны планеты на #3 .\n".
...
$LOCA["fr"]["GRAVITON_ATK_10"] = "Флот с планеты #1 #2 достигает луны планеты на #3 . Звезда смерти направляет свою гравитонную пушку на спутник. Лёгкие вибрации сотрясают поверхность луны. Но что-то тут не так. Гравитонная пушка приводит звезду смерти в колебания. Начинается отдача. Звезда смерти разлетается на миллионы кусочков. Возникающая при этом ударная волна уничтожает весь Ваш флот. Доигрался...\n".
"<br>Шанс на уничтожение луны: #4 %. Шанс на уничтожение звезды смерти:#5 %";

$LOCA["fr"]["GRAVITON_ATK_11"] = "Флот с планеты #1 #2  достигает луны на орбите планеты #3 . Ваша звезда смерти направляет свою гравитонную пушку на спутник. Толчки на поверхности луны всё нарастают. Луна начинает деформироваться и разрывается. Гигантские обломки летят на Ваш флот. Отступать уже поздно. Весь Ваш флот уничтожается градом обломков. Какой облом...\n".
"<br>Шансы на уничтожение луны: #4 %. Шансы на уничтожение звезды смерти: #5%.";

// Pour le défenseur.

$LOCA["fr"]["GRAVITON_DEF_00"] = "Флот с планеты #1 #2 достигает луны Вашей планеты на #3.\n" .
...
$LOCA["fr"]["GRAVITON_DEF_01"] = "Флот с планеты #1 #2 достигает луны твоей планеты на #3.\n".
...
$LOCA["fr"]["GRAVITON_DEF_10"] = "Флот с планеты #1 #2 достигает луны Вашей планеты  на #3.\n".
...
$LOCA["fr"]["GRAVITON_DEF_11"] = "Флот с планеты #1 #2 достигает луны Вашей планеты на #3.\n".
