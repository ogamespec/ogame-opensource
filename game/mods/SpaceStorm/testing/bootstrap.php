...
// Bootstrap for the Space Storm modification's own PHPUnit test suite.
//
// This loads the game core with the in-memory SQLite backend
// (DB_CONNECTION=sqlite, DB_DATABASE=:memory:) so the mod's DB-backed hooks can be
// tested without a MySQL server, then loads the Space Storm modification itself
// (the SpaceStorm class and its constants).
//
...
// Load the Space Storm modification (SpaceStorm class + constants).
