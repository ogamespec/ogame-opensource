    ...
    public function controller () : bool {
        ...
        if ( method () === "POST" )
        {
            ...
            if ( $this->write_error === "" )
            {
                ...
                $from = htmlspecialchars($GlobalUser['oname']) . " <a href=\"index.php?page=galaxy&galaxy=".$ownhome['g']."&system=".$ownhome['s']."&position=".$ownhome['p']."&session={PUBLIC_SESSION}\">[".$ownhome['g'].":".$ownhome['s'].":".$ownhome['p']."]</a>\n";
