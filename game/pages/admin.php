...
function Admin_Queue ()
{
    ...
    while ($rows--) 
    {
        ...
        echo "<tr><th>".$queue['end']."</th><th><a href=\"index.php?page=admin&session=$session&mode=Users&player_id=$player_id\">".$user['oname']."</a></th><th>".$queue['type']."</th><th>".QueueDesc($queue)."</th><th>".$queue['prio']."</th></tr>\n";
    }
