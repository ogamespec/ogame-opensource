    ...
    public function view () : void {
        ...
        <center>
            ...
            <table width=600>
                ...
                <tr>
                    <td class=l><img border='0' src="img/DMaterie.jpg" align='top' width='120' height='120'></td>
                    <td class=l><strong><?php echo loca("NAME_".GID_RC_DM);?></strong><br>
                        <?php echo loca("PREM_DM_INFO");?>
                ...
                <tr>
                    ...
                    <td class=l rowspan="2"><b><?php echo loca("PREM_COMMANDER");?></b>(<b><?php echo OfficerLeft(USER_OFFICER_COMMANDER);?></b>)<br>
                        <?php echo loca("PREM_COMMANDER_INFO");?>
                        <div style="margin:4px 4px;">
                            <table>
                                <tr>
                                    <td><img src="img/commander_ikon.gif" width="32" height="32" style="vertical-align:middle;" alt="<?php echo loca("PREM_COMMANDER");?>"></td>
                                    <td style='background-color:transparent;'><strong style="color:skyblue; vertical-align:middle;"><?php echo loca("PREM_COMMANDER_NOTE");?></strong></td>
                                </tr>
                            </table>
                        </div>
                    </td>
                    <td class=l style="width:90px;text-align:center; vertical-align:middle;">
                        <a href='index.php?page=micropayment&buynow=1&type=1&days=90&session=<?php echo $session;?>' >
                            <b><?php echo loca("PREM_3MONTH");?><br><font color=lime><?php echo loca("PREM_TOTAL");?> <?php echo nicenum($price[1]*10);?></font><br><?php echo loca("NAME_".GID_RC_DM);?></b></a>
                        </td>
                    </tr>
                    <tr>
                        <td class=l style="width:90px;text-align:center; vertical-align:middle;">
                            <a href='index.php?page=micropayment&buynow=1&type=1&days=7&session=<?php echo $session;?>' >
                                <b><?php echo loca("PREM_WEEK");?><br><font color=lime><?php echo nicenum($price[1]);?></font><br><?php echo loca("NAME_".GID_RC_DM);?></b></a>
                            </td>
                        </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class=l rowspan="2"><b><?php echo loca("PREM_ADMIRAL");?></b>(<b><?php echo OfficerLeft(USER_OFFICER_ADMIRAL);?>)<br>
                    ...
                    <td class=l style="width:90px;text-align:center; vertical-align:middle;">
                        <a href='index.php?page=micropayment&buynow=1&type=2&days=90&session=<?php echo $session;?>' >
                            <b><?php echo loca("PREM_3MONTH");?><br><font color=lime><?php echo loca("PREM_TOTAL");?> <?php echo nicenum($price[2]*10);?></font><br><?php echo loca("NAME_".GID_RC_DM);?></b></a>
                        </td>
                    </tr>
                    <tr>
                        <td class=l style="width:90px;text-align:center; vertical-align:middle;">
                            <a href='index.php?page=micropayment&buynow=1&type=2&days=7&session=<?php echo $session;?>' >
                                <b><?php echo loca("PREM_WEEK");?><br><font color=lime><?php echo nicenum($price[2]);?></font><br><?php echo loca("NAME_".GID_RC_DM);?></b></a>
                            </td>
                        </tr>
                <tr>
                    <td colspan="3" class="c" style='height:4px;'></td>
                ...
                <tr>
                    ...
                    <td class=l rowspan="2"><b><?php echo loca("PREM_ENGINEER");?></b>(<b><?php echo OfficerLeft(USER_OFFICER_ENGINEER);?></b>)<br>
                    ...
                    <td class=l style="width:90px;text-align:center; vertical-align:middle;">
                        <a href='index.php?page=micropayment&buynow=1&type=3&days=90&session=<?php echo $session;?>' >
                            <b><?php echo loca("PREM_3MONTH");?><br><font color=lime><?php echo loca("PREM_TOTAL");?> <?php echo nicenum($price[3]*10);?></font><br><?php echo loca("NAME_".GID_RC_DM);?></b></a>
                        </td>
                    </tr>
                    <tr>
                        <td class=l style="width:90px;text-align:center; vertical-align:middle;">
                            <a href='index.php?page=micropayment&buynow=1&type=3&days=7&session=<?php echo $session;?>' >
                                <b><?php echo loca("PREM_WEEK");?><br><font color=lime><?php echo nicenum($price[3]);?></font><br><?php echo loca("NAME_".GID_RC_DM);?></b></a>
                            </td>
                        </tr>
                <tr>
                    <td colspan="3" class="c" style='height:4px;'></td>
                ...
                <tr>
                    ...
                    <td class=l rowspan="2"><b><?php echo loca("PREM_GEOLOGE");?></b>(<b><?php echo OfficerLeft(USER_OFFICER_GEOLOGE);?></b>)<br>
                    ...
                    <td class=l style="width:90px;text-align:center; vertical-align:middle;">
                        <a href='index.php?page=micropayment&buynow=1&type=4&days=90&session=<?php echo $session;?>' >
                            <b><?php echo loca("PREM_3MONTH");?><br><font color=lime><?php echo loca("PREM_TOTAL");?> <?php echo nicenum($price[4]*10);?></font><br><?php echo loca("NAME_".GID_RC_DM);?></b></a>
                        </td>
                    </tr>
                    <tr>
                        <td class=l style="width:90px;text-align:center; vertical-align:middle;">
                            <a href='index.php?page=micropayment&buynow=1&type=4&days=7&session=<?php echo $session;?>' >
                                <b><?php echo loca("PREM_WEEK");?><br><font color=lime><?php echo nicenum($price[4]);?></font><br><?php echo loca("NAME_".GID_RC_DM);?></b></a>
                            </td>
                        </tr>
                <tr>
                    <td colspan="3" class="c" style='height:4px;'></td>
                ...
                <tr>
                    ...
                    <td class=l rowspan="2"><b><?php echo loca("PREM_TECHNOCRATE");?></b>(<b><?php echo OfficerLeft(USER_OFFICER_TECHNOCRATE);?></b>)<br>
                    ...
                    <td class=l style="width:90px;text-align:center; vertical-align:middle;">
                        <a href='index.php?page=micropayment&buynow=1&type=5&days=90&session=<?php echo $session;?>' >
                            <b><?php echo loca("PREM_3MONTH");?><br><font color=lime><?php echo loca("PREM_TOTAL");?> <?php echo nicenum($price[5]*10);?></font><br><?php echo loca("NAME_".GID_RC_DM);?></b></a>
                        </td>
                    </tr>
                    <tr>
                        <td class=l style="width:90px;text-align:center; vertical-align:middle;">
                            <a href='index.php?page=micropayment&buynow=1&type=5&days=7&session=<?php echo $session;?>' >
                                <b><?php echo loca("PREM_WEEK");?><br><font color=lime><?php echo nicenum($price[5]);?></font><br><?php echo loca("NAME_".GID_RC_DM);?></b></a>
                            </td>
                        </tr>
            </table>
            <br>
