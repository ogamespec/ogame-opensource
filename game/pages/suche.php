...
class Suche extends Page {
    ...
    private function search_selected ( string $opt ) : string
    {
        ...
        ?>
         ...
         <table width="519"> 
          ...
          <tr> 
           <th> 
            <select name="type"> 
             <option value="playername" <?php echo $this->search_selected("playername");?>><?php echo loca("SEARCH_SEL_USER");?></option> 
             <option value="planetname" <?php echo $this->search_selected("planetname");?>><?php echo loca("SEARCH_SEL_PLANET");?></option> 
             <option value="allytag" <?php echo $this->search_selected("allytag");?>><?php echo loca("SEARCH_SEL_TAG");?></option> 
             <option value="allyname" <?php echo $this->search_selected("allyname");?>><?php echo loca("SEARCH_SEL_ALLY");?></option> 
            </select> 
            &nbsp;&nbsp;
