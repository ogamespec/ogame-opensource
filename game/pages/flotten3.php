...
class Flotten3 extends Page {
    ...
    public function view () : void {
        ...
        <tr height="20" align="left">
            <td class="c" colspan="2"><?php echo $this->galaxy;?>:<?php echo $this->system;?>:<?php echo $this->planet;?> - <?php echo loca("FLEET_PLANETTYPE_".intval($_POST['planettype']));?></td>
        </tr>
        <tr valign="top" align="left">
            <th width="50%">
                ...
                $missions = FleetAvailableMissions ( 
                    ...
                    $this->galaxy, $this->system, $this->planet, intval($_POST['planettype']), $fleet );
                ...
                else
                {
                    foreach ($missions as $i=>$id) 
                    {
                        ...
                        {
                            $checked = (key_exists('target_mission', $_POST) && intval($_POST['target_mission']) == $id) ? "checked" : "";
                            echo "    <tr height=\"20\">\n";
                            echo "<th>\n";
                            echo "  <input type=\"radio\" name=\"order\" value=\"$id\" $checked>".loca("FLEET_ORDER_$id")."<br />\n";
                            echo "     </th>\n";
                            echo "  </tr>\n";
                        }
                    }
