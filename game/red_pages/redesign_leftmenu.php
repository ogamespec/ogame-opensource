...
<div id="links">
    ...
    <ul id="menuTable" class="leftmenu">
        ...
        <span class="menu_icon">
                   ...
                   target="_self">
          	        <img class="mouseSwitch" 
          	             src="red_images/dbe21bc0819f9e6f5a626cf901e4c7.gif" 
          	             height="29" 
          	             width="38" 
          	             rel="red_images/7b643c6864d216bee72ce404e74072.gif"/>
          	    </a>
          	                </span>
        ...
        <li>
        <span class="menu_icon">
                              	    <img src="red_images/4c01463c41c7503f24afd2d90804c6.gif" height="29" width="38" />
          	                </span>
            <a class="menubutton "
        ...
        <li>
        <span class="menu_icon">
                              	    <img src="red_images/a3a00daf8e8344790bbfbd377d5794.gif" height="29" width="38" />
          	                </span>
        ...
        <li>
        <span class="menu_icon">
                              	    <img src="red_images/8822e24278a0b4bdb0cb2b52cf7f4e.gif" height="29" width="38" />
          	                </span>
            <a class="menubutton "
        ...
        <li>
        <span class="menu_icon">
                              	    <img src="red_images/3a1b0e15ebce20dcea04da23eedbba.gif" height="29" width="38" />
          	                </span>
            <a class="menubutton "
        ...
        <span class="menu_icon">
                   ...
                   target="_self">
          	        <img class="mouseSwitch" 
          	             src="red_images/3306093fa95dd704a1420b192110e5.gif" 
          	             height="29" 
          	             width="38" 
        ...
        <li>
        <span class="menu_icon">
                              	    <img src="red_images/11b32cf746afcdd4bc896373186a3d.gif" height="29" width="38" />
          	                </span>
            <a class="menubutton "
        ...
        <li>
        <span class="menu_icon">
                              	    <img src="red_images/c01bc8256e563a37ada4ff86fbd0e8.gif" height="29" width="38" />
          	                </span>
            <a class="menubutton "
               href="index.php?page=empire&session=<?=$session;?>"
               accesskey=""
               target="_blank">
                <span class="textlabel">Империя</span>
            </a>
    </li>

        <li>
        <span class="menu_icon">
                                    <a href="index.php?page=alliance&tab=broadcast&session=<?=$session;?>"
                   class=""
                   target="_self">
          	        <img class="mouseSwitch" 
          	             src="red_images/e95e882e8916c0be653cb7a57e9581.gif" 
          	             height="29" 
          	             width="38" 
          	             rel="red_images/2a714b5e1d5709caaa29cb29a46747.gif"/>
          	    </a>
          	                </span>
            <a class="menubutton "
        ...
        <li>
        <span class="menu_icon">
                              	    <img src="red_images/e77402177b37bee59124d784aa81d5.gif" height="29" width="38" />
          	                </span>
            <a class="menubutton premiumHighligt"
