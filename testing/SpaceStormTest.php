...
// shared PHPUnit process together with the other pure tests.
//
// The mod's main.php is required here directly: it defines the SpaceStorm
// GameMod subclass and its constant block. The game core (defs, techs, and the
// GameMod base class) is loaded by testing/bootstrap.php.
...
class SpaceStormTest extends TestCase
{
    ...
    {
        // The mod needs the game constants (GID_*, SPACE_STORM_*, BATTLE_PTCP_*).
