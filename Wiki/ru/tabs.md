...
|rate_k|DOUBLE| | 
|rate_d|DOUBLE| |
|score1|BIGINT|Очки за постройки, флот, исследования | 
|score2|INT| | 
|score3|INT| | 
|place1|INT|Место за постройки, флот, исследования | 
|place2|INT| | 
|place3|INT| |
|oldscore1|BIGINT|Старые очки за постройки, флот, исследования | 
|oldscore2|INT| | 
|oldscore3|INT| | 
|oldplace1|INT|старое место за постройки, флот, исследования | 
|oldplace2|INT| | 
|oldplace3|INT| | 
|scoredate|INT UNSIGNED|Время сохранения старой статистики |
|r106|INT|Уровень исследования XXX | 
|r108|INT| | 
|r109|INT| | 
|r110|INT| | 
|r111|INT| | 
