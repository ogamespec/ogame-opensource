...
|702|DOUBLE|дейтерия | 
|prod1|DOUBLE|Процент выработки шахты металла (0...1)| 
|prod2|DOUBLE|Процент выработки шахты кристалла (0...1)| 
|prod3|DOUBLE|Процент выработки шахты дейтерия (0...1)| 
|prod4|DOUBLE|Процент выработки солнечной электростанции (0...1)| 
|prod12|DOUBLE|Процент выработки термояда (0...1)| 
|prod212|DOUBLE|Процент выработки солнечных спутников (0...1)| 
...
|freeze|INT|Приостановить завершение выполнения задания|
|frozen|INT UNSIGNED|Время начала приостановки завершения выполнения задания|
