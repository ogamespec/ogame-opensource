...
<img width="1553" height="801" alt="image" src="/imgstore/2576af5b-cb0f-42ab-885f-d61255ca528e.png" />

Переходим в локальный Git репозиторий проекта и запускаем команду `docker compose up --build`:

<img width="711" height="210" alt="image" src="/imgstore/3a85a86e-013b-4fe6-acd3-5d275626e07f.png" />
...
<img width="1553" height="801" alt="image" src="/imgstore/b0b8752b-7b08-4176-a633-455eba6d0b65.png" />

## Настройка Лобби и установка Master базы

Открываем `localhost` и вводим кредентиалы для подулючения к MySQL root:

<img width="931" height="525" alt="image" src="/imgstore/eea522b1-7e2c-4c96-b14e-f18ef7c31904.png" />
...
<img width="406" height="517" alt="image" src="/imgstore/edb51356-290c-410d-97e3-3ea8011f8b20.png" />

Создаём базу `uni` для хранения данных вселенной:

<img width="834" height="302" alt="image" src="/imgstore/2de38ce3-8487-4bd4-8ac2-2ff5002343da.png" />

Переходим в игру по адресу `localhost/game` и настраиваем всё как на картинке:

<img width="987" height="885" alt="image" src="/imgstore/a9b2ecc3-c238-4a2d-b018-fad229d88dc1.png" />
...
<img width="1720" height="700" alt="image" src="/imgstore/21a6b1a9-38bc-4c46-8811-1fc6b34b0685.png" />
...
<img width="597" height="698" alt="image" src="/imgstore/5537d55c-bfc5-49e7-9d36-eb621cd33dcf.png" />
