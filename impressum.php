...
hr {
	...
	border:0px;
	border-bottom:1px dashed #9EBDE4;
	clear:both;
	width:100%;
}
...
<li>Не будет платных функций (Тёмной Материи, Офицеров и Скупщика), однако меню 'Империя' будет доступно </li>
</ul>

Будут исправлены ошибки оригинальной версии 0.84: 
<ul>
<li>Багнутая планета при попытке колонизации 10й планеты. На её месте будет Уничтоженная планета. </li>
