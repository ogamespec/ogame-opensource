...
// var tb_pathToImage = "/cdn/img/layout/indicator.white.gif";
var tb_pathToImage = "/cdn/img/cluetip/wait.gif";
...
function tb_init(domChunk){
    ...
    $(domChunk).unbind('click', handler);
    $(domChunk).bind('click', handler);
}
                ...
                for (TB_Counter = 0; ((TB_Counter < TB_TempArray.length) && (TB_NextHTML === "")); TB_Counter++) {
                    ...
                    if (!(TB_TempArray[TB_Counter].href == url)) {						
                        if (TB_FoundURL) {
                            ...
                            TB_NextHTML = "<span id='TB_next'>&nbsp;&nbsp;<a href='javascript:void(0);'>Next &gt;</a></span>";
                        } else {
                            TB_PrevCaption = TB_TempArray[TB_Counter].title;
                            TB_PrevURL = TB_TempArray[TB_Counter].href;
                            TB_PrevHTML = "<span id='TB_prev'>&nbsp;&nbsp;<a href='javascript:void(0);'>&lt; Prev</a></span>";
                        }
                    } else {
                        TB_FoundURL = true;
