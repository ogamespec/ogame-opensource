...
- Попросить помощи у сообщества. Дискорд: https://discord.gg/xpCV3McAj2

:warning: Товарищи разработчики! Не пугайтесь если видите много щита в корне репозитория. Всё это вам возможно не нужно, это запчасти для Docker, PHPStan и PHPUnit. Основные исходники находятся в папке `game`.
